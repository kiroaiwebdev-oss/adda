...
<head>
    ...
    <title>500 - Server Error | Internship Adda</title>
...
<body>
    ...
    <!-- 500 Error Content -->
    <div class="error-container flex items-center justify-center bg-gradient-to-br from-red-50 via-white to-orange-50">
        <div class="container mx-auto px-4 py-16 md:py-20">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="flex justify-center mb-8">
                    <div class="w-24 h-24 bg-gradient-to-br from-red-500 to-orange-600 rounded-full flex items-center justify-center shadow-2xl">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center mb-16">
                    <button onclick="location.reload()" class="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-primary-600 to-primary-700 text-white font-bold rounded-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
                    ...
                    <a href="/" class="inline-flex items-center justify-center px-8 py-4 bg-white text-primary-600 font-bold rounded-xl border-2 border-primary-200 hover:border-primary-400 hover:bg-primary-50 transition-all duration-300">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="max-w-2xl mx-auto bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-100">
                        <a href="/contact.html" class="inline-flex items-center text-primary-600 font-semibold hover:text-primary-700 transition-colors">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
