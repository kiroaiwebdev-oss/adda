...
.badge-success,.status-published,.status-active,.status-approved,.status-completed{background:rgba(67,122,34,0.12);color:var(--success)}
.badge-muted,.status-draft,.status-inactive{background:rgba(107,114,128,0.15);color:var(--muted)}
.badge-warning,.status-pending,.status-applied{background:rgba(218,113,1,0.15);color:var(--orange)}
.badge-error,.status-rejected,.status-failed{background:rgba(161,44,123,0.12);color:var(--error)}
.badge-info,.status-contacted{background:rgba(22,163,74,0.12);color:var(--primary)}
...
.btn-error{background:rgba(161,44,123,0.1);color:var(--error)}
.btn-error:hover{background:rgba(161,44,123,0.18)}
...
.alert-warn{background:rgba(218,113,1,0.08);border:1px solid rgba(218,113,1,0.3);color:var(--orange)}
.alert-info{background:rgba(22,163,74,0.07);border:1px solid rgba(22,163,74,0.2);color:var(--primary)}
