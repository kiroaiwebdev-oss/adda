...
// ✅ NO ID CHECK - This is CREATE page
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="ml-64 min-h-screen">
        ...
        <div class="px-8 py-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h1 class="text-3xl font-bold text-gray-900">Create New Internship</h1>
                    <p class="text-gray-600 mt-1">Add a new internship program to your platform</p>
                </div>
    ...
    <main class="p-8">
        <form id="createForm" class="max-w-5xl mx-auto">
                ...
                <div class="space-y-4">
                    ...
                    <div class="h-64 bg-gradient-to-br from-primary-100 to-indigo-100 rounded-lg border-2 border-dashed border-gray-300 flex items-center justify-center">
                        <div class="text-center">
                            ...
                            <p class="text-gray-600 font-medium">Upload cover image or enter URL</p>
                        </div>
                    </div>
...
<script>
    ...
    document.getElementById('coverImageUrl').addEventListener('blur', (e) => {
        ...
        if (url && (url.startsWith('http://') || url.startsWith('https://'))) {
            ...
            img.src = url;
            img.onerror = () => alert('Failed to load image from URL. Please check the URL.');
            img.onload = () => document.getElementById('imagePreview').classList.remove('hidden');
        }
    });
    ...
    // Form submission - CREATE (not UPDATE)
    document.getElementById('createForm').addEventListener('submit', async (e) => {
        ...
        try {
            const response = await fetch('/api/internships.php?action=create', {
                method: 'POST',
            ...
            if (result.success) {
                window.location.href = 'list.php?success=Internship created successfully!';
            } else {
