            ...
            <table width="620" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.08);">
                ...
                <tr>
                    <td style="padding:0 50px;text-align:center;background:#f0fdf4;border-bottom:2px dashed #86efac;">
                        ...
                        <p style="margin:16px 0;color:#166534;font-size:13px;font-weight:500;">Offer ID: #<?php echo htmlspecialchars($offer_id, ENT_QUOTES, 'UTF-8'); ?></p>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding:40px 50px;">
                        <p style="margin:0 0 20px;font-size:16px;color:#374151;">Dear <strong style="color:#111827;"><?php echo htmlspecialchars($name, ENT_QUOTES, 'UTF-8'); ?></strong>,</p>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td style="padding:10px 0;border-bottom:1px solid #dcfce7;text-align:right;">
                                                <span style="font-size:14px;color:#111827;font-weight:600;"><?php echo htmlspecialchars($internship_title, ENT_QUOTES, 'UTF-8'); ?></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding:10px 0;border-bottom:1px solid #dcfce7;">
                                            ...
                                            <td style="padding:10px 0;border-bottom:1px solid #dcfce7;text-align:right;">
                                                <span style="font-size:14px;color:#111827;font-weight:600;"><?php echo htmlspecialchars($internship_duration, ENT_QUOTES, 'UTF-8'); ?></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding:10px 0;border-bottom:1px solid #dcfce7;">
                                                <span style="font-size:13px;color:#6b7280;font-weight:500;">Mode</span>
                                            </td>
                                            <td style="padding:10px 0;border-bottom:1px solid #dcfce7;text-align:right;">
                                                <span style="font-size:14px;color:#111827;font-weight:600;"><?php echo htmlspecialchars($internship_type, ENT_QUOTES, 'UTF-8'); ?></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding:10px 0;border-bottom:1px solid #dcfce7;">
                                            ...
                                            <td style="padding:10px 0;border-bottom:1px solid #dcfce7;text-align:right;">
                                                <span style="font-size:14px;color:#111827;font-weight:600;"><?php echo htmlspecialchars($enrollment_date, ENT_QUOTES, 'UTF-8'); ?></span>
                                            </td>
                                        </tr>
                                        <tr>
                            ...
                            <tr>
                                <td align="center">
                                    <a href="https://internshipadda.com/app/views/learner/my-internships.php" 
                                       style="display:inline-block;background:#16a34a;color:#ffffff;text-decoration:none;font-size:15px;font-weight:700;padding:14px 40px;border-radius:8px;letter-spacing:0.3px;">
                ...
                <tr>
                    <td style="background:#f9fafb;border-top:1px solid #e5e7eb;padding:24px 50px;text-align:center;">
                        <p style="margin:0;font-size:12px;color:#9ca3af;">
                            ...
                            &copy; <?php echo date('Y'); ?> Internship Adda. All rights reserved.
                        </p>
